...
export default function NewProductPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(error.message || 'יצירת המוצר נכשלה');
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleInputChange}
                className="w-full p-2 border border-gray-400 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                placeholder="הכנס כמות יחידות במוצר"
                min="0"
                step="0.1"
              />
            </div>
          ...
          {/* <div className="flex items-center">
            <input
              ...
              onChange={handleInputChange}
              className="h-4 w-4 text-blue-600 rounded border-gray-400 ml-2"
            />
          ...
          <div className="flex justify-end gap-4">
            <Link
              href="/dashboard/products"
              className="px-4 py-2 border border-gray-400 rounded-lg hover:bg-gray-100 transition-colors"
            >
              ביטול
            </Link>
            <button
